...
def test-repos-pagination [url: string] {
    print "verifying /repos pagination..."
    ...
    print "/repos pagination passed!"
}

def test-repos-validation-errors [url: string] {
    ...
    print "/repos validation errors passed!"
}
...
def main [] {
    ...
    test-repos-pagination $url
    test-repos-validation-errors $url
